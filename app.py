        ...
        with st.spinner("Анализируем отчёты..."):
            try:
                ...
                prompt = (
                    ...
                    "- В файле 'buffer_account' сравни общую маржу за вчера и с начала месяца. Сделай вывод: маржа растёт, падает или стабильна.\n"
                    "- В таблицах 'low_margin_yesterday' и 'low_margin_month' найди товары с маржой ниже 20%. Напиши: 'Обратите внимание на следующие товары — маржинальность крайне низкая, по ним почти нет заработка.'\n"

                    "- В таблицах 'high_drr_yesterday' и 'high_drr_month' найди товары с ДРР выше 15% при нормальной марже. Напиши: 'В этих товарах маркетинговые расходы съедают всю прибыль. Рекомендуется проверить настройки рекламных кампаний.'\n"
                    "- Укажи, какие товары перестали быть проблемными и какие попали в зону риска.\n"
                    "- Сделай 5–7 чётких рекомендаций по улучшению маржи, продаж и управлению ассортиментом.\n\n"
                    f"{full_report}"
                )
