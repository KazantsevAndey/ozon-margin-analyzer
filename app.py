        ...
        with st.spinner("Анализируем отчёты..."):
            try:
                ...
                prompt = (
                    ...
                    "- В таблицах 'high_drr_yesterday' и 'high_drr_month' найди товары с ДРР выше 15% при нормальной марже. Напиши: 'В этих товарах маркетинговые расходы съедают всю прибыль. Рекомендуется проверить настройки рекламных кампаний.' Используй такую формулиовку и перечисли товары\n"
