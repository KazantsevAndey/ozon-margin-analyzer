        ...
        with st.spinner("Анализируем отчёты..."):
            try:
                ...
                prompt = (
                    ...
                    "- Сравни маржу по аккаунту: за вчера и с начала месяца.\n"
                    "- Укажи, уходит ли товар из группы проблемных или наоборот попадает туда.\n"
                    "- Сделай 5–7 рекомендаций по улучшению маржи и продаж.\n\n"
                    f"{full_report}"
                )
